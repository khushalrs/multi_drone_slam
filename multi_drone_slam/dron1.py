...
class OffboardTakeoff(Node):
    def __init__(self):
        ...
        self.armed = False
        self.current_position = [-3.0, 0.0, 0.0]
        ...
        self.state_sub = self.create_subscription(
            State, '/drone2/state', self.state_cb, 10)
        ...
        self.position_sub = self.create_subscription(
            PoseStamped, '/drone2/local_position/pose', self.position_cb, position_qos)
        ...
        # wait for services
        self.get_logger().info('Waiting for /drone2/set_mode service...')
        self.mode_client.wait_for_service()
        self.get_logger().info('Waiting for /drone2/cmd/arming service...')
